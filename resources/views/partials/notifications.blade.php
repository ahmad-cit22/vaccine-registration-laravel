...
@if (session()->has('error'))
    <div class="bg-red-200 px-6 py-4 my-4 rounded-md text-lg flex justify-center items-center mx-auto max-w-lg">
...
@if (session()->has('warning'))
    <div class="bg-orange-200 px-6 py-4 my-4 rounded-md text-lg flex justify-center items-center mx-auto max-w-lg">
...
@if (session()->has('info'))
    <div class="bg-blue-200 px-6 py-4 my-4 rounded-md text-lg flex justify-center items-center mx-auto max-w-lg">
